...
<script>
    ...
    // 🛠️ FLATTENED STRUCTURAL DISPATCH PAYLOAD:
    // Formats reward items into plain key: value format matching master_sheet column rules perfectly
    function executeFinalTransaction() {
        ...
        for (let key in cart) {
            if (cart[key] > 0) {
                // Pass directly as 'Reward1': quantity, 'Reward2': quantity to align with Apps Script expectations
