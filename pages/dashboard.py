...
# 🎯 CENTERED STACK DESIGN OVERWRITE: Vertically pairs and centers the buttons perfectly
st.markdown("""
<style>
    .stApp {
    ...
    /* 🛠️ ALIGNMENT ENGINE: Centers the button rows natively in the layout stack */
    ...
    /* Target inner button wrappers to prevent layout bleeding */
    ...
    div.stButton > button[key="sys_refresh_btn"] {
        ...
        width: 424px !important; /* Perfect match matching your main action UI components below */
    ...
    /* 🛒 STORE BUTTON (CENTERED DIRECTLY BELOW OUTLINE) */
    div.stButton > button[key="sys_route_store_btn"] {
        ...
        border-radius: 6px !important;
        padding: 0.5rem 1.5rem !important;
        width: 424px !important; /* Perfectly mirrors the look, width, and center axis */
        max-width: 100% !important;
...
# Top Position: Centered Action Data Refresher
if st.button("Update Data 🔄", key="sys_refresh_btn"):
    st.cache_data.clear()
    st.rerun()

# Directly Below: Centered Yellow Store Navigation Row
